...
//                || NotificationPreferenceFragment.class.getName().equals(fragmentName)
                || FlightPreferenceFragment.class.getName().equals(fragmentName)
                || DevicesPreferenceFragment.class.getName().equals(fragmentName)
                || ControlConfigurationsPreferenceFragment.class.getName().equals(fragmentName)
...
//    }
    ...
    public static class FlightPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_flight);
            setHasOptionsMenu(true);
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
//            bindPreferenceSummaryToValue(findPreference("minimal_upper_distance"));
        }
...
//            bindPreferenceSummaryToValue(findPreference("minimal_upper_distance"));
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class ControlConfigurationsPreferenceFragment extends PreferenceFragment {
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        addPreferencesFromResource(R.xml.pref_control_configurations);
        setHasOptionsMenu(true);
...
//            bindPreferenceSummaryToValue(findPreference("minimal_upper_distance"));
    ...
    public static class LogPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
//            bindPreferenceSummaryToValue(findPreference("enable_logs"));
        }
